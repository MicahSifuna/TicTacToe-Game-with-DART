...
void main() {
  while (true) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        while (true) {
          ...
          if (x == null) {
            print('Your input got problem. Type a number from 1-3 please.');
            print('x: ');
    ...
    String reply = stdin.readLineSync() ?? '0';
...
List<List<int>> initBoard() {
  ...
  List<List<int>> b = [List.filled(3, 0), List.filled(3, 0), List.filled(3, 0)];
